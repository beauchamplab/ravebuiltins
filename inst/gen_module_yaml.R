...
config = list(
  ...
  init_function = '__init__beauchamplab_power_explorer',
  main_function = '__main__beauchamplab_power_explorer',
  reactive_function = '__reactive__beauchamplab_power_explorer',
